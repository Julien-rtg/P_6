 ...
 */
final class Version20221025080157 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commentaire ADD id_figure_id INT NOT NULL, ADD id_utilisateur_id INT NOT NULL, DROP id_figure, DROP id_utilisateur');
        ...
        $this->addSql('ALTER TABLE figure CHANGE id_utilisateur id_utilisateur_id INT NOT NULL');
        $this->addSql('CREATE INDEX IDX_2F57B37AC6EE5C49 ON figure (id_utilisateur_id)');
        $this->addSql('DROP INDEX IDX_7AE8C45285F5AD92 ON photo_figure');
        $this->addSql('ALTER TABLE photo_figure CHANGE id_figure id_figure_id INT NOT NULL');
        $this->addSql('CREATE INDEX IDX_7AE8C45285F5AD92 ON photo_figure (id_figure_id)');
        $this->addSql('DROP INDEX IDX_170013B785F5AD92 ON video_figure');
        $this->addSql('ALTER TABLE video_figure CHANGE id_figure id_figure_id INT NOT NULL');
        $this->addSql('CREATE INDEX IDX_170013B785F5AD92 ON video_figure (id_figure_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_67F068BC85F5AD92 ON commentaire');
        $this->addSql('DROP INDEX IDX_67F068BCC6EE5C49 ON commentaire');
        $this->addSql('ALTER TABLE commentaire ADD id_figure INT NOT NULL, ADD id_utilisateur INT NOT NULL, DROP id_figure_id, DROP id_utilisateur_id');
