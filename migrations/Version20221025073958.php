 ...
 */
final class Version20221025073958 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commentaire ADD id_figure INT NOT NULL, ADD id_utilisateur INT DEFAULT NULL, DROP id_figure, DROP id_utilisateur');
        ...
        $this->addSql('ALTER TABLE figure CHANGE groupe_figure groupe_figure INT NOT NULL, CHANGE id_utilisateur id_utilisateur INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_67F068BC85F5AD92 ON commentaire');
        $this->addSql('DROP INDEX IDX_67F068BCC6EE5C49 ON commentaire');
        $this->addSql('ALTER TABLE commentaire ADD id_utilisateur INT NOT NULL, DROP id_utilisateur_id, CHANGE id_figure_id id_figure INT NOT NULL');
        $this->addSql('CREATE INDEX IDX_67F068BC85F5AD92 ON commentaire (id_figure)');
        $this->addSql('CREATE INDEX IDX_67F068BCC6EE5C49 ON commentaire (id_utilisateur)');
        $this->addSql('ALTER TABLE figure DROP FOREIGN KEY FK_2F57B37AC6EE5C49');
        $this->addSql('DROP INDEX IDX_2F57B37AC6EE5C49 ON figure');
        $this->addSql('ALTER TABLE figure CHANGE groupe_figure groupe_figure INT NOT NULL COMMENT \'1=Grabs // 2=Rotations // 3=Flips\', CHANGE id_utilisateur_id id_utilisateur INT NOT NULL');
        $this->addSql('CREATE INDEX IDX_2F57B37AC6EE5C49 ON figure (id_utilisateur)');
